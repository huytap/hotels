                    ...
                    <div class="row form-bk">
                        ...
                        <div class="col-md-1 col-sm-2 col-xs-6">
                            <div class="form-groups">
                                ...
                                <div class="date">
                                    <?php echo CHtml::dropDownlist('FormBook[adult]', $adult, array(1=>1,2,3), array('class'=>'form-control'));?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-1 col-sm-2 col-xs-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-xs-12 f-info">
                    ...
                    <div class="card-type"><img src="<?php //echo Yii::app()->baseUrl?>/images/payment-card.jpg"></div>
                </div>
