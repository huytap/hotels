...
Yii::app()->clientScript->registerScriptFile(Yii::app()->theme->baseUrl.'/js/custom.js?ver=003', CClientScript::POS_END, array('defer'=>'defer'));
?>
<!DOCTYPE html>
<html>
<head>
    ...
    if(isset($_GET['hotel_id']) && isset($_GET['chain_id'])){
        ...
        if($_GET['chain_id'] == 'riverside-resort'){
            echo'<style>.header{
                    background:#24324a;
                }
                </style>';
            ...
            <div class="container"> 
                <div class="row">
                    <div class="col-md-12 col-xs-12 logo text-center">
                        ...
                        <a href="<?php echo Yii::app()->params['link'].'booking/'.$hotel['hotel_id'].'/'.$hotel['chain_id']?>">
                        <?php 
...
<a href="#" id="back-to-top" title="Back to top" class="show"><span class="fa fa-angle-up"></span></a><script type="text/javascript" src="<?php echo Yii::app()->theme->baseUrl?>/js/jquery-1.12.0.min.js"></script>
