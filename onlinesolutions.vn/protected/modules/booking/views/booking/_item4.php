	        	...
	        	<div class="row promotions row-promos <?php //echo $notshow?>" rel="<?php echo $promo['promotion_id'] ?>">
					...
					<div class="col-md-3 col-xs-6 col-sm-3 rate rate-result m-right">
						<span class="price-old">
							<?php 
							if($promo[$params['adult']]<$room[$params['adult']]){
						...
						<span class="currency-txt">
							<?php
							$price = $promo[$params['adult']]; 
							if($params['adult'] >2){
								//echo"<pre>";print_r($room);echo"</pre>";
								$price = $promo[2] + ($room['extrabed_price']*($params['adult']-2));
							}
							echo ExtraHelper::roundMoney3($room['currency'], $price) ;
							?></span><br>
