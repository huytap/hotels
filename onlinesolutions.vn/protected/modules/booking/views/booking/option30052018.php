            ...
            <?php
                ...
                if($dropoffs){?>
                    <div class="row">                        
                        ...
                        <div class="col-sm-9 no-padding" id="drop_info" style="<?php if((isset($booked['dropoff']) && $booked['dropoff'] !== NULL)  || $promotion->dropoff) echo 'display:block;'; else echo 'display:none;';?>">
                            <div class="col-sm-4">
