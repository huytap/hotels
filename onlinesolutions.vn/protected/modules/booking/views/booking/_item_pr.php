...
?>
<div class="per-room" id="promotions">
	<div class="row">
		<div class="col-md-3">
			<div class="roomtypes pid" rel="<?php echo $room['promotion_id']?>">
			    <div class="child" rel="#pr_<?=$room['promotion_id']?>">
...
<?php }else{
	echo '<div class="row" style="min-height:300px">'.
            ...
            '<p>The hotel is not available for your requested travel dates. It is either sold out or not yet open for reservations. Please choose other day or contact us via: <a href="mailto:reservations@ambassadorhotelgroup.com">reservations@harmonysaigonhotel.com</a></div></div>';
}?>