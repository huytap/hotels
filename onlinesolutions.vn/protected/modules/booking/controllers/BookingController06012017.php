            ...
            if(Yii::app()->session['_booked'] && $book){
                ...
                if(isset($_POST['BookingForm'])){
                    ...
                    if(!$booking->hasErrors()){                        
                        ...
                        $book->short_id = ExtraHelper::generateRandomString(10, 1, true);
                        ...
                        if($book->save()){    
                            ...
                            if($book->update()){
                                ...
                                $lang  = Yii::app()->session['_lang'];
                                $this->redirect(Yii::app()->params['booking'].'booking/thankyou?short_id='.$book->short_id);        
                            }
