    ...
    <div class="basiccus section col-xs-12">
        ...
        <div class="col-sm-9 wrapper-content p-t15">
            <div class="col-sm-3 p-none-l form-group">
                ...
                <?php echo $form->dropDownlist($model, 'chain_id', array('' => '------------')+Chain::model()->getList(), array('class' => 'form-control input-sm'));?>
                <?php echo $form->error($model, 'chain_id'); ?>
            </div>
            <div class="col-sm-3 p-none-r form-group">
                <?php echo $form->label($model, 'hotel_id');?>
                <?php echo $form->textField($model, 'hotel_id', array('class' => 'form-control input-sm', 'placeholder' => 'Hotel ID'));?>
    ...
    <div class="basiccus section col-xs-12">
     ...
     <div class="basiccus section col-xs-12">
        <div class="col-sm-3 ws-nm">
            ...
            <p>Use private link css field to connect your server and private local css on our server</p>
        </div>
        <div class="col-sm-9 wrapper-content p-t15">
            <div class="col-sm-12 p-none form-group">
                <?php echo $form->label($model, 'private_local_css');?>
                <?php echo $form->textField($model, 'private_local_css', array('class' => 'form-control input-sm', 'placeholder' => 'Private Local Css'));?>
                <?php echo $form->error($model, 'private_local_css'); ?>
            </div>
            <div class="col-sm-12 p-none form-group">
                <?php echo $form->label($model, 'private_link_css');?>
                <?php echo $form->textField($model, 'private_link_css', array('class' => 'form-control input-sm', 'placeholder' => 'Private Link Css'));?>
                <?php echo $form->error($model, 'private_link_css'); ?>
            </div>
        </div>
    </div>
    <div class="basiccus section col-xs-12">
                        ...
                        foreach($language as $key => $lang){
                            ...
                            <div class="tab-pane fade in <?php echo $class?>" id="<?php echo $key?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php //echo $form->textArea($model, "short_description[$key]", array('class' => 'form-control', 'rows'=>'6', 'placeholder' => 'Short Description')); ?>
                                </div> 
                                <div class="form-group">
