...
<input type="hidden" name="Promotion[type]" value="others">
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <?php echo $form->textField($model, 'start_deal_date', array('class' => 'form-control datepicker'));?>
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <?php echo $form->textField($model, 'end_deal_date', array('class' => 'form-control datepicker'));?>
