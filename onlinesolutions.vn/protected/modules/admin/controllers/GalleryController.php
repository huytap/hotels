...
class GalleryController extends AdminController
{
        ...
        if (isset($_POST['Gallery'])) {
            ...
            if (isset($image) && count($image) > 0) {
                ...
                foreach ($image as $key => $value) {
                    ...
                    $gallery_item->name = date("Y-m-d-H-i-s") . '-' . str_replace(array(' ','(',')','*'), '', $value->name);
                ...
                $this->redirect(Yii::app()->createAbsoluteUrl('admin/gallery/view', array('id'=>$gallery_id)));
            }
        }
    ...
    public function actionUpload($id){
        ...
        if (isset($_POST['Gallery'])) {
            ...
            $this->redirect(Yii::app()->createAbsoluteUrl('admin/gallery/view', array('id'=>$id)));
        }
    ...
    public function actionView($id){
        ...
        $hotel = Hotel::model()->findByPk($gallery['hotel_id']);
