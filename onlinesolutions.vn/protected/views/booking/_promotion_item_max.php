<div class="col-md-5 col-xs-12 col-sm-5 rate-result <?php echo $notshow?>">
	<div class="pr-name">
...
<div class="col-md-3 col-xs-6 rate rate-result">
	...
	<span class="currency-txt">
		<?php 
			$nights = $promo['bookedNights']-$promo['max_stay'];
			echo number_format(($promo[$params['adult']]+($room[$params['adult']]*$nights))/($nights+1)	, 2) ;
