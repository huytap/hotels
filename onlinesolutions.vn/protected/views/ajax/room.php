		...
		<div>
		    ...
		    <div class="room-desc">
                    <div class="des">
                        ...
                        <p><?php echo Yii::t('lang', 'number_room') ?>: <?php echo $room['no_of_rooms'] ?></p>
	                    <p><?php echo Yii::t('lang', 'max_occupancy') ?>: <?php echo $room['max_per_room'] ?></p>
                        <p><?php echo Yii::t('lang', 'size_room') ?>: <?php echo $room['size_of_room'] ?> sqm</p>
                    ...
                    <?php
                       if ($room['amenities']) {
                            foreach (explode(',', $room['amenities']) as $key => $value) {
                                echo '<li>' . ucwords(Yii::t('lang', $value)) . '</li>';
                            }
                        }?>
                    </ul> 
                </div>
