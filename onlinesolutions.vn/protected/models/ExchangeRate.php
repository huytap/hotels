...
class ExchangeRate extends CActiveRecord
{
	...
	public function convertCurrencyToUSD($currency='USD'){
		...
		if(!$ex_currency){
			$ex_currency = $data['USD'];
		}
		return $ex_currency;
	}

	public function convertCurrencyToUSD2($currency='USD', $the_date){
	...
	public function getList2(){
	 ...
	 public function exchangeRate2($default, $change){
		$defaultRate = (array)ExchangeRate::model()->convertCurrencyToUSD($default);
		$changeRate = (array)ExchangeRate::model()->convertCurrencyToUSD($change);
