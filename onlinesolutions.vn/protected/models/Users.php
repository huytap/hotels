...
class Users extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('username, fullname, email, chain_id', 'required', 'on'=>'create,update'),
			array('new_password', 'safe','on'=>'create,update'),
			...
			array('username, password, hotel_id', 'length', 'max'=>128),
	...
	public function equalPasswords($attribute, $params){
	    ...
	    if ($user->password !== sha1(md5($this->old_password).'bookingengine')){
