    ...
    <div class="basiccus section col-xs-12">
        ...
        <div class="col-md-9 wrapper-content p-t15">
            ...
            <div class="col-sm-6 p-none-r form-group">
                ...
                <?php echo $form->dropDownlist($model, "type", array(''=>'-----Type-----') + Yii::app()->params['cms_type'], array('class'=>'form-control')); ?>
                <?php echo $form->error($model, 'type'); ?>
            </div>
            <div class="clear"></div>
            <div class="col-sm-3 p-none-l form-group" id="times" style="<?php if($model['type'] == 'destination') echo 'display:block';else echo 'display:none';?>">
                <?php echo $form->label($model, 'minute');?>
                <?php echo $form->dropDownlist($model, "minute", array('' => '---------') +Yii::app()->params['type_des'], array('class' => 'form-control')); ?>
            ...
            <div class="col-sm-3 p-none-l form-group">
                ...
                <?php echo $form->fileField($model, "icon", array('class' => 'form-control')); ?>
                <?php echo $form->error($model, 'icon'); ?>
            </div>
            <?php
            if($model->icon){?>
                <div class="col-sm-3 p-none-r form-group">
                    <?php echo '<img src="'.Yii::app()->baseUrl.'/uploads/cover/'.$model->icon.'" width="100">';?>
                </div>
            <?php
            }
            ?> 
