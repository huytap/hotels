...
class Roomtype extends CActiveRecord
{
	...
	public function getList($status='', $hotel=''){
		...
		$dataProvider = new CActiveDataProvider($this, array('criteria' => $criteria,'sort'=>array('defaultOrder'=>'display_order asc')));
	...
	public function getListOther($id){
		$criteria = new CDbCriteria;
		$criteria->compare('status', 0, false, 'AND');
		$criteria->addCondition('id!='.$id);
		$dataProvider = new CActiveDataProvider($this, array('criteria' => $criteria,'sort'=>array('defaultOrder'=>'display_order desc')));
		$dataProvider->setPagination(false);
		return $dataProvider;
	}
	...
	public function getRoomtypeBySlug($slug){
		$criteria = new CDbCriteria;
