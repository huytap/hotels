...
var flb_settings = $.extend({
        ...
        lightbox_background_opacity: 0.5,
    
        lightbox_border_width: 10, // (pixels)
    
        lightbox_border_color: '#fff',
        
        lightbox_z_index: '9999999999',
        ...
        lightbox_text_style: 'font-size: 14px; line-height: 1.4; color: #fff; text-align: center;',
        
        lightbox_text_anchor_link_style: 'text-decoration: underline; color: #fff;',
    
        lightbox_text_background_style: 'background: rgba(237,171,63,.85);',
